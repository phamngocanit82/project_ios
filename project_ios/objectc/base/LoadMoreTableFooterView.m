...
- (id)initWithFrame:(CGRect)frame arrowImageName:(NSString *)arrow textColor:(UIColor *)textColor  {
    if((self = [super initWithFrame:frame])) {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(55.0f, 65 - 48.0f, self.frame.size.width, 20.0f)];
        ...
        layer.frame = CGRectMake(28, 10, 20.0f, 30.0f);
        ...
        view.frame = CGRectMake(20.0f, label.frame.origin.y, 20.0f, 20.0f);
