...
#import "HelpersPlatform.h"
@implementation HelpersPlatform
+(BOOL)is_iPad{
    NSString *platform = [HelpersPlatform platform];
...
+(CGFloat)getRatio{
    if([self is_iPad]){
        if (HelpersPlatform.getWidth<=HelpersPlatform.getHeight){
            return HelpersPlatform.getWidth/768.0f;
        }else{
            return HelpersPlatform.getHeight/768.0f;
        }
    }else{
        if (HelpersPlatform.getWidth<=HelpersPlatform.getHeight){
            return HelpersPlatform.getWidth/320.0f;
        }else{
            return HelpersPlatform.getHeight/320.0f;
        }
    }
}
