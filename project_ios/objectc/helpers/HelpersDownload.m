...
#import "HelpersDownload.h"
#import "Constant.h"
#import "HelpersJson.h"
#import "HelpersCache.h"

@interface HelpersDownload(){
@private
    NSURLSessionDownloadTask *download;
    NSURLSession *defaultSession;
}
@end
@implementation HelpersDownload
-(id)init {
    if (self = [super init]) {
        self.strMethod = @"GET";
        self.type = @"";
...
#pragma clang diagnostic pop
    ...
    if (dic!=nil) {
        NSString * json_data = [HelpersJson stringFromObject:dic];
...
- (void)URLSession:(NSURLSession *)session downloadTask:(NSURLSessionDownloadTask *)downloadTask didFinishDownloadingToURL:(NSURL *)location{
    ...
    [HelpersCache destroyNetworkCache];
    [HelpersCache destroyLackingDataProtection];
}
