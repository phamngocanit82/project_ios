...
#import "CTCView.h"
#import "CTCLabel.h"
#import "CTCImageView.h"

@implementation CTCImageView
-(void)layoutSubviews{
...
-(void)imageWithPath:(NSObject*)object Path:(NSString*)strPath{
    ...
    className = [className stringByReplacingOccurrencesOfString:@"CTCImageView" withString:@"UIImageView"];
...
-(void)removeAnimation:(NSObject*)object{
    CTCImageView *imageView = (CTCImageView*)object;
    CTCView *contentView = (CTCView*)[CTHHelper controlFromTag:50 withView:imageView kind:[CTCView class]];
    if(contentView == nil)
        return;
    CTCView *animationView = (CTCView*)[CTHHelper controlFromTag:51 withView:contentView kind:[CTCView class]];
...
-(void)addAnimation:(NSObject*)object{
    ...
    if(contentView == nil){
        if(imageView.frame.size.width>=50&&imageView.frame.size.height>=50){
            CTCView *contentView = [[CTCView alloc] initWithFrame:CGRectMake(0, 0, 80 , 80)];
            CGFloat ratio = contentView.frame.size.height/50;
            contentView.tag = 50;
            contentView.backgroundColor = [UIColor whiteColor];
            CTCView *animationView = [[CTCView alloc] initWithFrame:CGRectMake(2, 2, contentView.frame.size.width-4 , contentView.frame.size.height-4)];
            ...
            CTCLabel *loadingLabel = [[CTCLabel alloc] initWithFrame:CGRectMake(0, animationView.frame.size.height-animationView.frame.size.height/2, animationView.frame.size.width , animationView.frame.size.height/4)];
            loadingLabel.tag = 53;
            ...
            CTCLabel *pleaseWaitLabel = [[CTCLabel alloc] initWithFrame:CGRectMake(0, animationView.frame.size.height-animationView.frame.size.height/4, animationView.frame.size.width , animationView.frame.size.height/4)];
            ...
            CTCView *contentView = [[CTCView alloc] initWithFrame:CGRectMake(0, 0, imageView.frame.size.width , imageView.frame.size.height)];
