...
#import "CTCTextField.h"
@implementation CTCTextField
...
- (void)textFieldDidChange{
    if (self.delegateCTCTextField && [self.delegateCTCTextField respondsToSelector:@selector(textFieldDidChange:)]) {
        [self.delegateCTCTextField textFieldDidChange:self];
    }
}
-(NSString*)trimming{
